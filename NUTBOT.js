(function () {
    ...
    var loadChat = function (cb) {
        ...
        $.get("https://cdn.rawgit.com/plugnutbot/nutbot/0.5.1/lang/langIndex.json", function (json) {
    ...
    var Makers = "This Bot Is What You Get When You Put Whitt38,Sydog247,GreatGamingTV And ItsHarrySteel Minds Together :)";
    ...
    var basicBot = {
        ...
        chatLink: "https://cdn.rawgit.com/plugnutbot/nutbot/0.5.1/lang/eng.json",
        chat: null,
        loadChat: loadChat,
        ...
        chatUtilities: {
            chatFilter: function (chat) {
                ...
                if (basicBot.chatcleaner(chat)) {
                 ...
                 var plugRoomLinkPatt = /(\b?:\/\/(www.)?plug\.dj[-A-Z0-9+&@#\/%?=~_|:,.;]*[-A-Z0-9+&@#\/%=~_|])/ig;
