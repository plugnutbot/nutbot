...
(function () {
    ...
    var loadChat = function (cb) {
        ...
        $.get("https://cdn.rawgit.com/plugnutbot/nutbot/0.5.7/lang/langIndex.json", function (json) {
    ...
    var basicBot = {
        ...
        chatLink: "https://cdn.rawgit.com/plugnutbot/nutbot/0.5.7/lang/eng.json",
        chat: null,
        loadChat: loadChat,
        ...
        settings: {
            ...
            blacklists: {
                ...
                Coms: "https://github.com/plugnutbot/nutbot/blob/0.5.8/blacklist.json"
            }
        },
        room: {
            users: [],
